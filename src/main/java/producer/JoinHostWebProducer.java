...
public class JoinHostWebProducer {
    private static final Logger logger = LoggerFactory.getLogger(JoinHostWebProducer.class);
...
//        String topic = "t_host_id_0614_1";
        ...
        while (true) {
            ...
            hostLog1.setMetricItem("disk");
            hostLog1.setMetricValue(1111);
            ...
            hostLog2.setMetricItem("cpu");
            hostLog2.setMetricValue(1600);
