...
public class HostWebLogProducer {
    private static final Logger logger = LoggerFactory.getLogger(HostWebLogProducer.class);
...
//        String topic = "t_host_id_0614_1";
        ...
        while (true) {
            HostWebLog hostLog1 = new HostWebLog();
            hostLog1.setId(1L);
            hostLog1.setCreatedTime(System.currentTimeMillis());
            hostLog1.setMetricItem("cpu");
            hostLog1.setMetricValue(1168);
            hostLog1.setLog(getLog());
            try {
            ...
            HostWebLog hostLog2 = new HostWebLog();
            hostLog2.setId(2L);
            hostLog2.setCreatedTime(System.currentTimeMillis());
            hostLog2.setMetricItem("disk");
            hostLog2.setMetricValue(116);
            hostLog2.setLog(getLog());
            try {
            ...
            HostWebLog hostLog3 = new HostWebLog();
            hostLog3.setId(1L);
            hostLog3.setCreatedTime(System.currentTimeMillis());
            hostLog3.setMetricItem("disk");
            hostLog3.setMetricValue(2100);
            hostLog3.setLog(getLog());
            try {
            ...
            HostWebLog hostLog5 = new HostWebLog();
            hostLog5.setId(2L);
            hostLog5.setCreatedTime(System.currentTimeMillis());
            hostLog5.setMetricItem("disk");
            hostLog5.setMetricValue(2200);
            hostLog5.setLog(getLog());
            try {
